...
//	@GetMapping("/teacherIddddd")
//
//	public ResponseEntity<Object> findTeacherId(@RequestParam String email) {
//		if (isLogin) {
//			try {
//				Teacher teacher = teacherService.getEmail(email);
//
//				return new ResponseEntity<>(teacher.getId(), HttpStatus.FOUND);
//			} catch (NoSuchElementException e) {
//				return new ResponseEntity<>("User not found incorrect id ", HttpStatus.NOT_FOUND);
//			}
//		} else
...
//	    public ResponseEntity<List<PoliceDTO>> getAllItemsByFeig(){
